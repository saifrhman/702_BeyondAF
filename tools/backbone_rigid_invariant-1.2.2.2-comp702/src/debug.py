...
if __name__ == '__main__':
    ...
    from bri.porter import run_matrix, process_distance_matrices
    input_path = Path('../proteins/app_test/test_output/compute_invariants')
    output_path = Path('../proteins/app_test/test_output')
    process_distance_matrices(input_path, output_path)
